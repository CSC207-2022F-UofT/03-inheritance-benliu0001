...
public abstract class Bag {
    ...
    public String popItem(){
        if (this.numberOfContents < 1){
            ...
            String returnVal = this.contents[this.numberOfContents - 1];
    ...
    public void increaseCapacity(int n) {
        ...
        String[] copyThing = new String[this.contents.length + n];
        System.arraycopy(this.contents, 0, copyThing, 0, this.contents.length);
        this.contents = copyThing;
